...
export class RestaurantsService {
    ...
    async createRestaurant(owner: User, createRestaurantInput: CreateRestaurantInput): Promise<CreateRestaurantOutput> {
        ...
        try {
            ...
            if (!category) {
               const createCategory = this.categories.create({ name: categoryName, slug: categorySlug });
    ...
    async editRestaurant(owner: User, _editRestaurantInput: EditRestaurantInput) {}
}
